...
function M.generate_syntax()
   ...
   set_hl("DiagnosticVirtualTextError", { fg = palette.red, bg = palette.bg_red })
   set_hl("DiagnosticVirtualTextInfo", { fg = palette.aqua, bg = palette.bg_green })
   set_hl("DiagnosticVirtualTextHint", { fg = palette.blue, bg = palette.bg_blue })
   set_hl("DiagnosticVirtualTextOk", { fg = palette.green, bg = palette.bg_green })
   set_hl("DiagnosticVirtualTextWarn", { fg = palette.yellow, bg = palette.bg_yellow })
   ...
   set_hl("EndOfBuffer", { fg = palette.bg0 })
   ...
   set_hl("@tag.blade", { fg = palette.yellow, bold = true })
   set_hl("@tag.delimiter", { fg = palette.red, bold = false })
   set_hl("@tag.delimiter.blade", { link = "@tag.blade" })
